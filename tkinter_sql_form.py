...
title_label = Label(window,text="Candidate Registration Form",width =30,font=("Helvetica", 14, "bold italic"),background='light green')
title_label.place(x=120,y=70)

lb_fullname = Label(window,text="FullName",width =20,font=("arial",10,"bold"),background='light green')
...
lb_password = Label(window,text="Password",width =20,font=("arial",10,"bold"),background='light green')
...
lb_retype_password = Label(window,text="Confirm Password",width =20,font=("arial",10,"bold"),background='light green')
...
lb_email = Label(window,text="Email ID",width =20,font=("arial",10,"bold"),background='light green')
...
lb_gender = Label(window,text="Gender",width =20,font=("arial",10,"bold"),background='light green')
lb_gender.place(x=42,y=280)
Radiobutton(window,text="Male",padx =5,variable=v_gender,value=1,background='light green').place(x=230,y=280)
Radiobutton(window,text="Female",padx =20,variable=v_gender,value=2,background='light green').place(x=290,y=280)
gender_get=v_gender.get()
...
lb_dob = Label(window,text="DOB MM/DD/YYYY",width =20,font=("arial",10,"bold"),background='light green')
lb_dob.place(x=70,y=310)
entry_mode=DateEntry(window,width=30)
entry_mode.place(x=240,y=310)


lb_address = Label(window,text="Address",width =20,font=("arial",10,"bold"),background='light green')
lb_address.place(x=45,y=340)
user_address = Text(window,width=30,height=4)
user_address.place(x=240,y=340)

lb_language = Label(window,text="Language",width =20,font=("arial",10,"bold"),background='light green')
...
course_label = Label(window,text="Select Field",width =20,font=("arial",10,"bold"),background='light green')
course_label.place(x=50,y=450)
check1=Checkbutton(window,text='Python', onvalue = 1, offvalue = 0,variable=v_check1,background='light green')
check1.place(x=240,y=450)
check2=Checkbutton(window,text='Java',onvalue = 1, offvalue = 0,variable=v_check2,background='light green')
check2.place(x=340,y=450)
check3=Checkbutton(window,text='Javascript' ,onvalue = 1, offvalue = 0,variable=v_check3,background='light green')
...
def showrecord():
    ...
    record_label=Label(window3,text=print_record,bg='PeachPuff')
...
def admin():
    ...
    login_button = Button(window2,text = "LOGIN",command=validate_admin,bg='blue',fg='white').place(x=220,y=210)
    window2.mainloop()
